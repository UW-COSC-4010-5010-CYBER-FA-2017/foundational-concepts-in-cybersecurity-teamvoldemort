 ...
 *
 * EVIL! This is the evil program that will overwrite the correct
 ...
 */
 ...
 int main(void)
 {
   ...
   //printf("EVIL:reading from shared mem\n");
   //meRead(*name);
   printf("EVIL:writing to shared mem\n");
   meWrite(*name);
 ...
 void meWrite(const char *name){
   ...
   const char *message = "This is the intercepted message";
